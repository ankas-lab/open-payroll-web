...
const ContractRow = ({ contract, i }: ContractRowProps) => {
  ...
  return loading === 'done' ? (
    <tr
      className={
        i % 2 === 0
          ? `flex gap-[50px] items-center text-[14px] font-normal text-black tracking-[0.25px] ${archivo.className}`
          : `flex gap-[50px] items-center text-[14px] bg-[#ECECEC] font-normal text-black tracking-[0.25px] ${archivo.className}`
      }
    >
